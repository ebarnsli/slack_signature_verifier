...
setup(
    ...
    description='Verify your request from slack with your slack signing secret',  # Give a short description about your library
    author='Erik Barns',  # Type in your name
    author_email='ebarns@labelinsight.com',  # Type in your E-Mail
    url='https://github.com/ebarnsli/slack_signature_verifier',  # Provide either the link to your github or to your website
